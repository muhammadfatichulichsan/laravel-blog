...
<body>
    <div class="cover">
        <h1>Error 404 <small>Girl Not Found</small></h1>
        <p class="lead">Please Check Your Face With Mirror :v</p>
    </div>

    <footer>
        <p>Technical Contact: <a href=mailto:muhammadfatichulichsan@gmail.com>muhammadfatichulichsan@gmail.co</a></p>
    </footer>
